...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    title: "운동 강사의 반복 기록 문제를 AI 제품 가설로 전환하고 실사용 베타로 검증하고 있습니다.",
  ...
  },
  {
    ...
    title: "B2B AI 기술의 고객 가치를 정의하고 B2C 상담사 PoC를 0→1로 설계했습니다.",
  ...
  },
  {
    ...
    title: "수작업 전사 병목을 STT 제품·운영 구조로 전환해 원가를 70%+ 절감했습니다.",
  ...
  },
  {
    ...
    involvement: { label: "기여도", value: "100%" },
    title: "커뮤니티의 학습 지속 문제를 OCR 기록·게이미피케이션 MVP로 구체화했습니다.",
  ...
  },
  {
    ...
    title: "검사 공정의 문제를 Vision AI PoC로 구체화하고 제안부터 종결까지 관리했습니다.",
